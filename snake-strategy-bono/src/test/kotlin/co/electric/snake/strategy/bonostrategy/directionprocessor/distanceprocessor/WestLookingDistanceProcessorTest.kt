...
internal class WestLookingDistanceProcessorTest {
    ...
    private val underTest = WestLookingDistanceProcessor()
    ...
    fun getDistanceShouldReturnEmptyOptionalWhenDirectionIsNotEast() {
        ...
        // WHEN
        val actual = underTest.getDistance(Direction.EAST, Coordinate(11, 1), Coordinate(1, 1), MAX_COORDINATE)
        // THEN
    ...
    fun getDistanceShouldReturnCorrectResultWhenDistanceProcessedDirectly() {
        ...
        // WHEN
        val actual = underTest.getDistance(Direction.WEST, Coordinate(11, 1), Coordinate(1, 1), MAX_COORDINATE)
        // THEN
        assertThat(actual).isEqualTo(expected)
    }
    ...
    fun getDistanceShouldReturnCorrectResultWhenDistanceProcessedClipped() {
        ...
        val expected = Optional.of(10)
        // WHEN
        val actual = underTest.getDistance(Direction.WEST, Coordinate(1, 1), Coordinate(41, 1), MAX_COORDINATE)
        // THEN
        assertThat(actual).isEqualTo(expected)
    }
